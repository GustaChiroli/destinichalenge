...
class StoryBrain {
  List<Story> data = _storyData;
  int _storyNumber = 0;

  getStory() {
    return data[_storyNumber].storyTitle;
  }

  getChoice1() {
    return data[_storyNumber].choice1;
  }

  getChoice2() {
    return data[_storyNumber].choice2;
  }
  ...
  nextStory(int choiceNumber) {
    ...
    if ((_storyNumber == 5) && (choiceNumber == 1)) {
      choiceNumber = 0;
      restart();
    }
    if ((_storyNumber == 4) && (choiceNumber == 1)) {
      choiceNumber = 0;
      restart();
    }
    if ((_storyNumber == 3) && (choiceNumber == 1)) {
      choiceNumber = 0;
      restart();
    }
  }
